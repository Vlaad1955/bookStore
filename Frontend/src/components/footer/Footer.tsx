        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.column}>
                    <h3>Покупцям</h3>
                    <ul>
                        <li><Link href={AppRoute.SIGN_UP}>Зареєструватись</Link></li>
                        <li><Link href={AppRoute.NEWS}>Новини</Link></li>
                        <li><Link href={AppRoute.BASKET}>Кошик</Link></li>
                    </ul>
