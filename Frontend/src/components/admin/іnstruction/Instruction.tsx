...
export default function AdminInstructions() {
    return (
        <main className={styles.container}>
            ...
            <p>Дана сторінка створена для керування <strong className={styles.fatty}>товарами</strong>, <strong className={styles.fatty}>новинами</strong>, <strong className={styles.fatty}>категоріями</strong> та <strong className={styles.fatty}>користувачами</strong> сайту.</p>

            <h2 className={styles.chapter}>🔹 Розділ 1: Керування товарами</h2>
            <ul className={styles.list}>
                <li>Пошук книг за <strong className={styles.fatty}>назвою</strong> та <strong className={styles.fatty}>станом</strong> (опублікована / неопублікована).</li>
            ...
            <ul>
                <li>Пошук новин за <strong className={styles.fatty}>назвою</strong> та <strong className={styles.fatty}>типом</strong> (general, promotion, event).</li>
            ...
            <ul>
                ...
                <li>Надання прав адміністратора іншим користувачам.
                    <em>Уважно! Усі адміністратори мають однакові права. Ви не можете забрати права в інших адміністраторів. Зверніться до менеджера.</em>
                </li>
            </ul>
