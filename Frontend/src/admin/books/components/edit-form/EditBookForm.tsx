...
export default function EditBookForm({ book }: { book: Book }) {
  ...
  const [cover, setCover] = useState<"soft" | "firm" | "">(
    (book.cover as "soft" | "firm") || ""
  );
  ...
  const [pendingData, setPendingData] = useState<UpdateBookDto | null>(null);
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.fieldGroupFull}>
          <label className={styles.label}>
            Категорії (можна вибрати кілька)
          </label>
